...
//!
//! Backport from upstream version of iced to pop-os fork
...
use iced_core::{Clipboard, Element, Layout, Length, Rectangle, Shell, Size, Widget};
    ...
    Renderer: iced_core::Renderer,
{
    ...
    fn enclose(this: Length, other: Length) -> Length {
        match (this, other) {
    ...
    pub fn push(mut self, child: impl Into<Element<'a, Message, Theme, Renderer>>) -> Self {
        ...
        if self.children.is_empty() {
            ...
            self.width = Self::enclose(self.width, child_size.width);
            self.height = Self::enclose(self.height, child_size.height);
        }
